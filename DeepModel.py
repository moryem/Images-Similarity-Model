...
class similarity_net:
    
    def __init__(self, dp, bs, ep, lr, y_tr, y_val, y_test, right_train, right_val, right_test,
                 left_train, left_val, left_test, im_to_vis, vis, plt_loss, plt_model):
# =============================================================================
...
# =============================================================================
        ...
        x = LeakyReLU(alpha=0.3)(x)
        x = Conv2D(63, (3, 3), strides=(1, 1), padding='same')(x)
        x = LeakyReLU(alpha=0.3)(x)
        x = BatchNormalization()(x)
        x = MaxPooling2D((2, 2))(x)
        x = Dropout(self.dp)(x)
...
# =============================================================================
        ...
        adam = optimizers.adam(lr=self.lr, beta_1=0.9, beta_2=0.95, epsilon=1e-7)
...
# =============================================================================
        ...
        self.history = self.reg_model.fit(x=[self.right_train, self.left_train], y=self.y_tr, 
...
# =============================================================================
        ...
        if not glob(os.path.join('.','vis_*')): 
            ...
            for i in self.im_to_vis:            
                ...
                self.visualize(loaded_twin, right_img, left_img, i)
    ...
    def visualize(self, twin_net, img, ref, im_num):
# =============================================================================
#           Visualize the outputs of the twins nets
# =============================================================================
